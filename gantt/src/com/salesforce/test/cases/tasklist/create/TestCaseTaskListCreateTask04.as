package com.salesforce.test.cases.tasklist.create
{
	...
	public class TestCaseTaskListCreateTask04 extends EventfulTestCase
	{
		private var appTreeParser : AppTreeParser;
		
		public function TestCaseTaskListCreateTask04(methodName:String=null)
		{
			super(methodName);
			appTreeParser = SeleniumFlexAPI.seleniumFlexAPI.appTreeParser;
		}
		...
		public  function step1(object : Object) : void{
			//listenForEvent(GridHelper.taskList,ListEvent.ITEM_CLICK,EVENT_EXPECTED);
		...
		public function step3() : void{
			TaskEditOverlayHelper.instance.selectStartDateToday();
			step4();
		}
		
		//Fields: - Fill End Date field with a correct date stamp.
		public function step4() : void{
			TaskEditOverlayHelper.instance.selectEndDateToday();
			step6();
		}
		
		//Change the duration for a negative number.
		//this step is not considered because of validation input in this field with re.
		public function step5() : void{
			TaskEditOverlayHelper.instance.insertTaskDuration(-1);
			assertFalse(AssertMessage.INVALID_DURATION,TaskEditOverlayHelper.validDuration());
			step6();
		}
		...
		public function verify(object : Object) : void{
			//trace("uuuhhh!!!");
			//assertEquals("Task name correct.",task.name,"task");	
		}
