package com.salesforce.test.cases.chart.undochanges
{
	...
	/**
	 *	Test Case : Undo the update of a task.
	 * 
	 *  @author Rodrigo Birriel - August 07, 2009
	*/
	
	public class TestCaseChartUndoChanges03 extends BaseTestCase
	{
		private var taskCreated : UiTask;
		
		public function TestCaseChartUndoChanges03() 
		{
		}
		...
		private function verify(object : Object) : void{
			...
			assertEquals(AssertMessage.TASK_COMPLETED_CHANGED,taskCreated.completed,taskAfterUndo.completed);
		}
